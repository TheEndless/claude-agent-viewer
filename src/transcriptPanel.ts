...
.result-body.raw pre, .result-body.raw code { margin: 0; padding: 0; background: none; border: none; font-family: inherit; color: inherit; white-space: inherit; word-break: inherit; }
